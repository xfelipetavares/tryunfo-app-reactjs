      ...
      <div className={styles.rightSide}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.infos}>
            <ul>
              <label htmlFor="">Atributo 1 ............................ <li data-testid="attr1-card">{cardAttr1}</li></label>
              
              <label htmlFor="">Atributo 2 ............................ <li data-testid="attr2-card">{cardAttr2}</li></label>
              
              <label htmlFor="">Atributo 3 ............................ <li data-testid="attr3-card">{cardAttr3}</li></label>
              <p className={styles.raridade} data-testid="rare-card"><span>Raridade</span> {cardRare}</p>
            </ul>
          </div>
